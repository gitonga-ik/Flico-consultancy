        ...
        <section id="book-details" className="py-12 px-4 sm:px-6 lg:px-8">
            ...
            <div className="mx-auto max-w-5xl bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
                <div className="flex flex-col md:flex-row min-h-112.5">
                    <div
                        className="w-full md:w-2/5 bg-gray-50 flex items-center justify-center p-8 border-b md:border-b-0 md:border-r border-gray-100">
                        <div
                  ...
                  <span className="text-xs text-gray-500 uppercase tracking-wider font-semibold">
                    ...
                    Ksh. {book.price}
                                ...
                                <button
                                    ...
                                    onClick={() => (document.getElementById('purchase-email-modal') as HTMLDialogElement | null)?.showModal()}
                                >
                                    Purchase Now
                                </button>
                                ...
                                <dialog id="purchase-email-modal" className="modal">
                                    <div className="modal-box max-w-md rounded-2xl">
                                        ...
                                        <h3 className="font-bold text-xl text-slate-800">Complete Your Purchase</h3>

                                        <p className="py-4 text-sm text-slate-500 leading-relaxed">
                                            Please enter a valid, active email address below. We will use this email to
                                            send your secure payment link and deliver your book download instantly once
                                            payment is complete.
                                        </p>
                                        ...
                                        <form method="dialog" onSubmit={handleSubmit}>
                                            ...
                                            <div className="modal-action mt-6 gap-2">
                                                <button
                                                    type="button"
                                                    onClick={() => (document.getElementById('purchase-email-modal') as HTMLDialogElement | null)?.close()}
