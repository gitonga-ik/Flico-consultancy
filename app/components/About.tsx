const About = () => {
  return (
    <>
      <section id="about" className="py-15 px-5 scroll-mt-16">
        ...
        <div className="container mx-auto max-w-5xl">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-white p-6 border-0 rounded-x1 shadow-[0_4px_12px_rgba(0,0,0,0.08)] hover:bg-[#a3d3d0] transition-colors duration-300">
        ...
        <div className="container mx-auto max-w-5xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {[
              ...
              <div
                key={index}
                className="bg-white p-6 border-0 rounded-x1 shadow-[0_4px_12px_rgba(0,0,0,0.08)] hover:bg-[#a3d3d0] transition-colors duration-300"
              >
      ...
      <section className="py-15 px-5 bg-[#e1e3e6]">
